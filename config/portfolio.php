    ...
    'education' => [
        ...
        [
            ...
            'description' => [
                ...
                'en' => 'Studied for three years, majoring in Science. Active in student organizations as Head of the Language Division in the Student Council and as a member of the student disciplinary board.',
                'ar' => 'درست لمدة ثلاث سنوات، تخصص العلوم في المدرسة الثانوية. نشط في المنظمات الطلابية كرئيس لقسم اللغة في مجلس الطلاب وكعضو في مجلس الانضباط الطلابي.',
            ],
        ],
        [
            'degree' => [
            ...
            'icon'   => 'fas fa-school',
            'description' => [
                'id' => 'Belajar selama tiga tahun, Menjadi anggota bagian bahasa dan aktif dalam kegiatan sekolah.',
                'en' => 'Studied for three years, becoming a member of the language section and actively participating in school activities.',
                'ar' => 'درست لمدة ثلاث سنوات، وأصبحت عضوًا في قسم اللغة وشاركت بنشاط في الأنشطة المدرسية.',
            ],
        ],
        [
            'degree' => [
            ...
            'icon'   => 'fas fa-school',
            'description' => [
                'id' => 'Sekolah dasar negeri negeri. Di sinilah seluruh perjalanan akademis saya dimulai.',
                'en' => 'Public elementary school. This is where my entire academic journey began.',
                'ar' => 'المدرسة الابتدائية العامة. من هنا بدأت رحلتي الأكاديمية بأكملها.',
            ],
        ],
    ],
